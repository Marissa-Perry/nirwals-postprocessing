...
MASKBITS = {
    ...
    'LOWTELLTRAN': (4, 'telluric transmission < 0.6'),
    'DONOTUSE':    (8, 'do not use for analysis (= BADPIX or LOWTELLTRAN)'),
}

# get bit values
MASK_BADPIX = MASKBITS['BADPIX'][0]
MASK_SKYLINE = MASKBITS['SKYLINE'][0]
MASK_LOWTELL = MASKBITS['LOWTELLTRAN'][0]
...
TELL_MIN = 0.6      # LOWTELLTRAN below this transmission
